...
export default class Read extends Component {
    ...
    addComment = e => {
        ...
        let r = 'posts/' + this.props.query.cat + '/' + this.props.query.pid
        firebase.database().ref('comments').push({
            ...comment,
            postId: r,
            title: this.state.post.title
        })
        firebase.database().ref(r).child('comments').push(comment).then(() => {
            this.setState({ formData: { name: '', comment: '' } })
        })
    }
    inputChanged = (e, type) => {
    ...
    getPosts = () => {
        ...
        firebase.database().ref('posts/' + this.props.query.cat + '/' + this.props.query.pid).on('value', s => {
                    ...
                    <div className="container page py-5">
                        <div className='row py-2 justify-content-center '>
                            ...
                            <div className='col-md-5 order-md-2' >
                                ...
                                <p className="body" dangerouslySetInnerHTML={{ __html: this.state.post.body }}></p>
                            ...
                            <div className="pt-3 pt-md-3 col-md-3 order-md-3 ">
                                <div className="sticky-top">
                                    ...
                                    <form onSubmit={this.addComment}>
                                        <input required onChange={e => this.inputChanged(e, 'name')} value={this.state.formData.name} className="form-control" type="text" placeholder="Your Name" />
                                        <textarea required onChange={e => this.inputChanged(e, 'comment')} value={this.state.formData.comment} className=" my-2 form-control" placeholder="Comment..." />
